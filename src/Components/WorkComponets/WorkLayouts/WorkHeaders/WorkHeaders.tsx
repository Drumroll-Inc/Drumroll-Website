    ...
    return (
        <div className={Styles.WorkHeadersContainer}>
            <div className={Styles.WorkHeadersItems}>
                ...
                <p className={Styles.WorkHeadersItemsPara}>Drumroll Digital partnered with Debbo Africa to create a powerful brand identity that captures the essence of Debbo Health's mission in Africa</p>
                <div className={Styles.WorkHeadersContainer2}>
